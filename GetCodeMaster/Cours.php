        ...
        <div class="row">
          ...
          <div class="col-md">
            <div class="card">
              ...
              />
              <div class="card-body">
                <h3 class="card-title">Création site Web</h3>
                <p class="card-text">
                   HTML et CSS sont des langages simples, que nous allons découvrir pas à pas, au cours de nombreux exercices. Vous serez bientôt capable d'ajouter du texte à votre site, de construire un menu de navigation, d'insérer des images... et bien plus encore !
                </p>
                <a href="#!" class="btn btn-primary disabled">Bientot !</a>
              </div>
            </div>         
